...
/**
 * Reference: https://usehooks.com/useEventListener/ Tweaked to run on both server and client sides. Reference
 * to window object takes place only on client side
 *
