		...
		return (
			<div className='space-y-1'>
				...
				<select
					...
					onBlur={onBlur}
					className={cn(
						'duration-250 app-scrollbar block h-32 w-full resize-none rounded-lg border p-2.5 leading-5 shadow-sm transition-colors focus:border-blue-400 focus:outline-0',
